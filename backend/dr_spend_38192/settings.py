"""
Django settings for dr_spend_38192 project.
...
ROOT_URLCONF = 'dr_spend_38192.urls'
...
WSGI_APPLICATION = 'dr_spend_38192.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dr_spend_38192 API",
    "DESCRIPTION": "API documentation for dr_spend_38192 App",
    "VERSION": "v1",
}
